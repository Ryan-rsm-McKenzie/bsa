...
TEST_CASE("bsa::detail::endian", "[src][common]")
{
...
TEST_CASE("bsa::detail::unicode", "[src][common]")
{
...
TEST_CASE("bsa::detail::mmio", "[src][common]")
{
...
TEST_CASE("bsa::detail::iostream_t", "[src][common]")
{
